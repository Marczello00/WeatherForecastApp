...
```
cd existing_repo
git remote add origin https://gitlab.com/programmic-languages-group/Mini-project-API.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.com/programmic-languages-group/Mini-project-API/-/settings/integrations)
